...
import AppClient from './bitcoin_client';
import { LedgerBridge } from './types';
const pathBase = 'm';
...
//  */
// function isOldStyleEthereumjsTx(tx: TypedTransaction | any) {
...
export class LedgerKeyring extends EventEmitter {
  ...
  //     address: string,
  //     rawTxHex: string,
  //     handleSigning: (payload: SignTransactionPayload) => TypedTransaction | any
  //   ): Promise<TypedTransaction | any> {
