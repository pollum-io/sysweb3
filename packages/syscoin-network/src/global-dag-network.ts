...
import {SyscoinNetwork} from './syscoin-network';
import {PeerNodeApi} from './api';

export class GlobalSyscoinNetwork extends SyscoinNetwork {
...
export const globalSyscoinNetwork = new GlobalSyscoinNetwork();
