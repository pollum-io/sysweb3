...
export declare type web3 = {
    ...
    sendTransaction: (sender: string, receiver: string, value: number) => Promise<TransactionReceipt>;
    ...
    getTokens: (address: string, tokenAddress: string) => Promise<IEthereumToken | undefined>;
