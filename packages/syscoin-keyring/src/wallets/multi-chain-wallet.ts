...
export class MultiChainWallet implements IKeyringWallet {
  ...
  readonly supportedAssets = [KeyringAssetType.SYS, KeyringAssetType.ETH, KeyringAssetType.ERC20];
  ...
  deserialize(data: KeyringWalletSerialized) {
    ...
    this.keyrings = [
      HdKeyring.create(this.mnemonic, BIP_44_PATHS.SYSCOIN_PATH, KeyringNetwork.Syscoin, 1),
