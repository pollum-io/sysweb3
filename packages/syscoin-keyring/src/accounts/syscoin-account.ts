...
export class SyscoinAccount extends EcdsaAccount implements IKeyringAccount {

  decimals = 8;
  network = KeyringNetwork.Syscoin;
  hasTokenSupport = false;
  supportedAssets = [KeyringAssetType.SYS];
  tokens = null; //SYSAssetLibrary.getDefaultAssets();
